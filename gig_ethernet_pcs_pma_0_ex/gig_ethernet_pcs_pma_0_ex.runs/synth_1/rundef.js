...
ISEStep( "vivado",
         "-log gig_ethernet_pcs_pma_0_example_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gig_ethernet_pcs_pma_0_example_design.tcl" );
